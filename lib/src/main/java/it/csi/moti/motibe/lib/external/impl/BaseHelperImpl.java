 ...
 * =========================LICENSE_END==================================
 */
package it.csi.moti.motibe.lib.external.impl;
...
import it.csi.moti.motibe.lib.external.itf.BaseHelper;
...
public abstract class BaseHelperImpl implements BaseHelper {
	...
	/**
	 * Transforms the paged list SIAC-like to paged list MOTI-like
	 * @param <A> the SIAC type
	 * @param <B> the MOTI type
	 * @param list the list
