...
import it.csi.moti.motibe.ejb.util.conf.ConfigurationValue;
import it.csi.moti.motibe.lib.dto.Utente;
import it.csi.moti.motibe.lib.util.log.LogUtil;
import it.csi.moti.motibe.web.util.filter.auth.AuthAdapter;
import it.csi.moti.motibe.web.util.filter.auth.NullAuthAdapter;
...
public class AuthFilter implements ContainerRequestFilter {
	...
	private void elaborateSecurityContext(Utente utente) {
		...
		MotiThreadLocalContainer.UTENTE_CONNESSO.set(utente);
	}
